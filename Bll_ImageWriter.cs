...
namespace Sunc_web_api.BLL
{
    ...
    /// </summary>   
    public class Bll_ImageWriter
    {
        /// <summary>   
        /// 生成一个新的水印图片制作实例   
        /// </summary>   
        public Bll_ImageWriter()
        {
            //   
        ...
        /// <param name="csizef"></param>
        /// <returns></returns>
        public bool fB_SetFontSize(ref Font crFont, ref SizeF crSize, Bitmap bmPhoto, string waterWords,int phWidth)
        {
        ...
        /// <param name="position">位置</param>   
        /// <returns></returns>   
        public bool DrawWords(ref Bitmap sourcePicture,
                                          string waterWords,
                                          float alpha,
                                          Color c,
            ...
            )
        {
            try
            {
                ...
                ////在这里我们定义一个数组来确定   
                //int[] sizes = new int[] { 16, 14, 12, 10, 8, 6, 4 };
                ////int[] sizes = new int[] {  8,10,12,14,16 };
                ...
                //这个画笔为描绘正式文字的笔刷，呈白色   
                SolidBrush semiTransBrush = new SolidBrush(c);
